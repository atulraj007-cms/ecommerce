...
$query = query("SELECT * FROM products WHERE product_id =" .$_GET['product']. "");
...
<div class="row">
    ...
    <div class="col-md-7">
       <img style="width:300px" src="./image/<?php echo $product_image; ?>" alt="">
    ...
    <div class="ratings">
        ...
        <p> <?php echo $product_short; ?></p>

   
    <form action="">
        <div class="form-group">
            <a href="../resource/cart.php?add=<?php echo $product_id; ?>" class="btn btn-primary">ADD TO CART</a>
        </div>
    </form>
